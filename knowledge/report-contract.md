...
1. Compact Review header (`#report-status`) with a circular issue-weighted score (accessible `Score N`, pending, or unavailable) plus diagnostic help that it is not a prediction of conversion or revenue, chronological full-Review history, and the owner Update review action
