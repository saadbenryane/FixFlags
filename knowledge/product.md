...
| Product surfaces (Product Review / Deep Review / Watch) | [product-system.md](./product-system.md) |
...
FixFlags is one intelligence with three depth surfaces:
- **Product Review** (free acquisition)
- **Deep Review** (paid journey depth)
...
- **Authenticated depth**: update reviews + deep review, one-click path retest, and recurring verification posture.
