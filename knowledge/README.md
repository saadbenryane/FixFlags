...
| What is the next implementation step? | [Roadmap](../ROADMAP.md), [execution](execution.md) |
...
| How do we speak and look? | [SOUL.md](../SOUL.md), [DESIGN.md](../DESIGN.md), [messaging](../docs/voice-and-copy.md) |
| What public language still needs to change? | [Messaging migration](../docs/messaging-migration.md) |
...
Customer objects are Site, Pages, Journey, Flag, Recommendation, Coverage and Connection. Outcome and Check remain internal model names; customer copy follows [messaging](../docs/voice-and-copy.md). The customer-facing loop is Flag. Fix. Verify., kept running by monitoring. Analyze is the acquisition CTA. Primary navigation is Home · Flags · Site. Checks and Verify / Observe / Connect are internal sources, not a required menu or product lineup.
