...
Product requirements and workspace interface: [docs/product-prd.md](../docs/product-prd.md), [docs/workspace-interface.md](../docs/workspace-interface.md).

1. **Complete loop** — `/report/[id]` is every ranked Flag, proof, copy, supporting context, and update review.
...
- Portable PI export + open local/protocol pieces ([open-source.md](./open-source.md))
...
- Rubric rewrite to five dimensions
- Backlog generator
