    ...
    <Section spacing="loose" className="relative overflow-hidden pb-8 sm:pb-12 lg:pb-16">
      ...
      <Container className="relative space-y-12 lg:space-y-16">
        <div className="mx-auto flex max-w-4xl flex-col items-center text-center">
          ...
          <Lead className="mx-auto mt-5 max-w-2xl">{HERO.subhead}</Lead>
        ...
        <div className={cn('motion-safe:animate-fade-in-up motion-safe:opacity-0 motion-safe:[animation-fill-mode:forwards] motion-safe:[animation-delay:200ms]')}>
          <HeroProductPreview />
        </div>
      </Container>
    </Section>
