...
| --- | --- | --- | --- | --- | --- | --- | --- |
| update-review-work-identity | in-progress | composer | main | reportId=work for Update review; active-only parent→child redirect; unify Product/Report handoff via startScanWithHandoff | re-check route, fetch-audit, load-report-route-state, ProductReviewAction, AuditPageActions, start-scan-handoff | Focused re-check/handoff/product tests + agent verify | 2026-08-27 |
