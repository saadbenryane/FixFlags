...
|---------|--------|-------|-----------------|-------|-------------|--------------|---------|
| homepage-complete-refinement | in_progress | codex-root | main | Reference-faithful homepage refinement, permanent product-true artwork, restored builder workflow, responsive density, and end-to-end homepage verification | components/marketing/landing, lib/marketing/copy/landing.ts, homepage assets and focused tests | Preserve report contracts, real integration truth, existing dirty design QA work, and current homepage journeys | 2026-07-28 |
