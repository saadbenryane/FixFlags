...
| --- | --- | --- | --- | --- | --- | --- | --- |
| public-review-depth | in-progress | grok | main | Plan-based reviewDepth: open-check unique public destinations, full review by plan, equal judgment, Flag-based score, lean coverage UI, pricing copy | url-identity, open-check, review-depth, runner, create-audit, pricing copy, report/product chrome | Preserve other owners' working-tree changes. Do not unpark CLI/MCP. | 2026-08-27 |
| app-chrome-honesty-closeout | in-progress | grok | main | Signed-in chrome tells one story: usage used-of-total, settings/billing IA, marketing copy, Help/QUALITY honesty, signed-in browser proof | permissions display limit, UsageMeter, dashboard, billing, settings, ProductWorkspace, help catalog surgical, QUALITY smoke | Preserve simplify-product-report-ux, knowledge-base-completion except two help articles, parked power-tool routes. Do not mark Game On release-attested. | 2026-08-27 |
| billing-usage-clarity | review | grok | main | Billing usage: used of plan total with a progress bar, no nested cards, show plan allowance even when local scans are unlimited | billing page, UsageMeter panel variant, USAGE_METER_COPY | Focused tests 6/6. Authenticated browser proof still needed. Preserve compact dashboard UsageMeter, settings-account-flatten, help catalog, top-five-refactors, simplify-product-report-ux | 2026-08-26 |
...
| settings-account-flatten | review | grok | main | Flatten settings Account: no nested cards, plan upgrade CTA, one Save changes with unsaved-leave warning, delete in a modal, merge passkeys/2FA into sign-in methods without a passkey name field | settings page, AccountSettingsForms, ConnectedAccounts, PasskeyTwoFactorSettings, AUTH.settings/security copy | Focused tests 7/7. Authenticated browser proof still needed. Preserve dashboard/product overview files, top-five-refactors, simplify-product-report-ux, and help catalog working-tree edits | 2026-08-26 |
| product-page-identity-review | review | grok | main | Product detail: tighter identity, Made with under the name, merged latest-review + score chart, drop redundant review list and Help visitors prefix | ProductWorkspace, ProductReviewTrend, MadeWithProfile placement, product-contract display | Focused tests 27/27. Preserve dashboard overview files, top-five-refactors, and report-prompt-chrome working-tree edits. Authenticated browser proof still needed. | 2026-08-26 |
| products-overview-evidence | review | grok | main | Products dashboard: compact usage at the top, Product rows show capture thumbnail + score sparkline | dashboard page/loading, ProductOverviewGrid, UsageMeter, loadProductOverview | Focused tests 21/21. Agent verify typecheck blocked by unrelated help catalog errors from concurrent catalog edits. No authenticated browser proof. | 2026-08-26 |
