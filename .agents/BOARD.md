...
| --- | --- | --- | --- | --- | --- | --- | --- |
| uptime-seven-days | in-progress | codex-uptime | main | User-requested seven-day uptime display in board prototype and homepage preview. | prototypes/fixflags-board/src/App.jsx, components/marketing/homepage/CareHomepage.tsx, lib/marketing/copy/care-homepage.ts | Preserve existing edits. | 2026-09-08 |
