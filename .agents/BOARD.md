...
|---------|--------|-------|-----------------|-------|-------------|--------------|---------|
| speed-opt-cwv | in_progress | auto | cursor/speed-opt-cwv-a9ac | Speed/CWV: homepage, report load, critical workflows | marketing homepage, layout/fonts, dynamic imports, report/audit client bundles, images, scripts | — | 2026-07-18 |
