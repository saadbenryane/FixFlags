...
|---------|--------|-------|-----------------|-------|-------------|--------------|---------|
| passkey-2fa | in_progress | auto | cursor/passkey-2fa-9529 | Passkey-based two-factor authentication | lib/auth*, prisma Passkey, settings security UI, sign-in 2FA challenge, SECURITY.md | — | 2026-07-18 |
