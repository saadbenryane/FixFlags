...
|---------|--------|-------|-----------------|-------|-------------|--------------|---------|
| docs-editor-integration-system | in_progress | codex-root | main | Public multi-page docs, canonical eight-editor integration contract, authenticated setup handoff, homepage/footer linked editor grid, route/content consolidation, and complete verification | app docs/help routes, components/docs and marketing integrations, lib/docs/integrations/mcp/marketing, setup wizard, CLI editor init, Prisma enum/migration, SEO and focused tests | Preserve unrelated API route and prompt work; external vendor-account smokes and release credentials remain separate proof requirements | 2026-07-29 |
| report-first-scan-auth | completed | codex-root | main | Immediate report-shaped scan handoff, mandatory anonymous auth gate, shared auth flows, progressive screenshot parity, denser report chrome, and per-Flag viewport comparison | components/audit, components/report, components/auth, report/auth routes, audit claim/access, canonical report/auth copy and focused tests | Implemented and verified with a real scan, responsive browser checks, focused tests, and repository validation | 2026-07-26 |
| app-wide-interface-copy-cleanup | in_progress | codex-root | main | Consolidate duplicated UI primitives, route states, checkout behavior, and reusable copy across every interface surface | components/ui, route error/loading states, billing/pricing actions, lib/marketing/copy, customer/admin/demo surfaces, focused guards and tests | Preserve routes, product contracts, approved design, and current behavior | 2026-07-26 |
