...
| --- | --- | --- | --- | --- | --- | --- | --- |
| update-review-work-identity | review | composer | main | reportId=work for Update review; active-only parent→child redirect; unify Product/Report handoff via startScanWithHandoff | re-check route, fetch-audit, load-report-route-state, ProductReviewAction, AuditPageActions, start-scan-handoff | Agent verify passed; session `.agents/sessions/2026-08-27-update-review-work-identity.md` | 2026-08-27 |
| products-dashboard-lean | review | composer | main | Lean Products dashboard copy; used-of-total meter; DemoSite sample when zero products; credit line in plan picker | dashboard, UsageMeter, ProductOverviewGrid, AuditInput, USAGE_METER_COPY, PRICING | Focused dashboard/meter/grid/AuditInput/PlanPicker tests green; tsc clean | 2026-08-27 |
| feedback-create-on-message | review | composer | main | SupportSession only after first visitor message; admin inbox/count exclude orphans; close empty OPEN | live-support sessions/messages, SupportWidget/Panel, AdminInbox, admin feedback/dashboard | Focused live-support + SupportChatPanel tests green; session `.agents/sessions/2026-08-27-feedback-create-on-message.md` | 2026-08-27 |
| fixflags-dogfood-quality | review | composer | main | Align Tasks with evidence; personal-site journey honesty; security-header consolidation; corpus | journey reviews, security-headers, page-purpose, heading IDs, editor-handoff, accuracy corpus | accuracy:eval green; dogfood-quality tests green; session `.agents/sessions/2026-08-27-fixflags-dogfood-quality.md` | 2026-08-27 |
...
| product-priorities-report-parity | review | composer | main | Reuse report explorer components (ReportFixLoop + FlagDetailPane) for Product Your priorities | ProductPriorities, explorer-model mapper, tests | Completed by product-prompt-chrome-parity (Copy All + contract) | 2026-08-27 |
