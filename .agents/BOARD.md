...
| top-five-refactors | in-progress | grok | main | Shrink agent OS, collapse parked report shell, quarantine power-tool UI, delete true dead code, collapse duplicate access/ranking | AGENTS/BOARD/skills/CODEMAP, ReportWorkspaceSplitShell, orphan MCP UI, completeness dead pins, access/ranking helpers | Preserve products-overview-evidence dashboard files and report-prompt-chrome working-tree edits | 2026-08-26 |
