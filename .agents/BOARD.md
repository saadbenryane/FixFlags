...
|---------|--------|-------|-----------------|-------|-------------|--------------|---------|
| unified-report-workspace | in_progress | codex-root | main | One report workspace model and shared presentation across completed, progressive, sample, shared, re-check, homepage proof, and dashboard release hub | lib/report, components/report, report composition in components/audit, sample presentation, dashboard summary, focused tests and durable design rules | Preserve current homepage changes, canonical report/access contracts, buildFixList ranking, and app-wide cleanup ownership | 2026-07-28 |
