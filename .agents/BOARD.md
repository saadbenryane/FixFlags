...
|---------|--------|-------|-----------------|-------|-------------|--------------|---------|
| report-first-scan-auth-refactor | in_progress | codex-root | main | Make anonymous scans navigate directly into the progressive report, scope the resume banner to reports already visited, and make report auth Google/GitHub-first with inline email and provider recovery | scan handoff and active-audit state, report auth components and copy, auth readiness, focused tests | Preserve current homepage work and existing report access, claim, and prompt-gating contracts | 2026-07-29 |
