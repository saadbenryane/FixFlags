...
| --- | --- | --- | --- | --- | --- | --- | --- |
| marketing-care-alignment | in-progress | cursor-marketing | main | Align public marketing type and copy with the homepage: drop mono display type, URL-first Site language, pricing/how-it-works/FAQ chrome. | `app/globals.css`, `DESIGN.md`, `components/pricing/*`, `components/marketing/*`, `lib/marketing/copy/{plans,faq,homepage}.ts`, how-it-works/faq/partners indexes | Preserve homepage-board-polish, shopify-app-launch waitlist join, site-cut-production-ship. No homepage CSS. No deploy. | 2026-09-08 |
