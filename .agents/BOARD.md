...
| site-game-on-core | in-progress | composer | main | Board-first Site: Care homepage kept; URL→`/sites/[id]` card board; check→card packaging; Free weekly Keep watching; Flag Fix/Verify from cards. | `lib/sites/*`, `app/sites/*`, `app/api/sites/*`, create-audit/handoff, entitlements, plans, Shopify fence, samples legacy note | Prisma migration `20260908150000_site_board_entities`. Preserve other agents' work. | 2026-09-08 |
