...
| --- | --- | --- | --- | --- | --- | --- | --- |
| game-on-wedge-honesty | in-progress | composer | main | Honest Agent\|Report wedge: truth lock, park-clean shell, Compare residue delete, Fixed dogfood, release packet honesty | PRODUCT, plans copy, workspace-interface, SplitShell, HomepageReportPreview, compare components, entitlements, sessions | Absorbs simplify-product-report-ux park contract; Fixed dogfood + operator release remain gates | 2026-08-29 |
