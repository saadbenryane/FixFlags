...
| --- | --- | --- | --- | --- | --- | --- | --- |
| homepage-board-polish | in-progress | cursor | main | Homepage board: undiluted Flag Orange, Experience card, Conversion Flag, header status, lean hero scan. | `components/marketing/homepage/*`, `lib/marketing/copy/care-homepage.ts` | Supersedes homepage-board-cleanup and homepage-flag-orange on the same files. Preserve SEO, Shopify, heartbeat, and site-cut-production-ship. No deploy. | 2026-09-08 |
