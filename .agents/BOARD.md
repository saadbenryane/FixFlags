...
Product direction as of 2026-09-08: [the revised vision](../knowledge/vision.md) and [phased roadmap](../ROADMAP.md) supersede earlier commercial bets and report-interface instructions below. Existing ownership remains; historical task wording is not authorization to build a separate Shopify product or preserve the report as the new experience.

| Task ID | Status | Owner | Branch/worktree | Scope | Files/areas | Dependencies | Updated |
| --- | --- | --- | --- | --- | --- | --- | --- |
| game-on-site-completeness | in-progress | cursor-seo-loop | main | Game On Site loop: production SHA, coverage-honest health, Flag verify, watch truth, one public story, park Product workspace. | `lib/sites/*`, `app/sites/*`, `app/api/sites/*`, `lib/audit/*`, marketing copy except homepage/FAQ owned files | Receipt: `.agents/sessions/game-on-site-completeness-2026-09-08.md`. Preserve homepage-board-polish, marketing-care-alignment (faq/plans/homepage), shopify-app-launch. Pushing for Railway SHA match. | 2026-09-08 |
...
| site-cut-production-ship | in-progress | cursor-seo-loop | main | Commit unpublished main work, push origin/main, and verify production health, homepage, sitemap, and hostname after Railway deploy. | working tree on `main`, production `fixflags.com` | Same ship as `game-on-site-completeness`. Next lint unblocked. Preserve other agents' leftover test files. No force-push. | 2026-09-08 |
