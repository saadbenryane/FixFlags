...
|---------|--------|-------|-----------------|-------|-------------|--------------|---------|
| homepage-report-reference-refactor | in_progress | codex-root | main | Rebuild the homepage sample report and editor workflow from the supplied visual reference, then align shared compact report chrome without changing report truth or access behavior | components/marketing/landing, shared compact report workspace primitives, lib/marketing/copy, focused UI tests | Preserve canonical report hierarchy, complete ranked Flag list, honest history, and current anonymous access rules | 2026-07-29 |
