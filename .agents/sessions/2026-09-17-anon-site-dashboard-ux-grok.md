...
- Anonymous post-audit board also hides Add card and empty “Not checked yet” area cards (Security/Tracking placeholders from the teaser check). Settings coverage hides the same empty rows, including Uptime/Accessibility.
