# QualityOS Marketing Research Workflows
...
| Pain (their words) | QualityOS area | Proof line | Objection |
|--------------------|----------------|------------|-----------|
...
Compare QualityOS to what the visitor already tries.

| Alternative | They promise | Gap QualityOS fills |
|-------------|--------------|---------------------|
