...
QualityOS serves two distinct jobs. Write for **one primary reader per page or block**. Mixing them dilutes conversion.
...
| Framework | Best for | QualityOS pattern |
|-----------|----------|-------------------|
...
| Dimension | Signals for QualityOS |
|-----------|----------------------|
...
```
For [segment] who [situation/trigger], QualityOS [mechanism] so they [outcome].
