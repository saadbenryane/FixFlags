...
- **v1.6 (Jul 2026)** — Completeness: CTA locked to Review my site; report chrome in `REPORT_COPY`; SVG hex allowlist; 0 partial capabilities; AiReviewPendingRefresh terminal UX.
