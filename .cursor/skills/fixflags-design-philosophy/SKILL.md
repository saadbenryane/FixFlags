...
|---|-----------|--------------------|----------------|
| 1 | **Visibility of system status** | The user always knows what's happening: queue position, scan progress, partial-data states, save/share status. | `AuditProgress`, `QueuePosition`, `Callout`, `ShareStatusBanner` |
