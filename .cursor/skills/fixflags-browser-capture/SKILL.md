...
Read [`AGENTS.md`](../../../AGENTS.md) first. **Playwright + Chromium only** on the audit path. Do not adopt chrome-devtools-mcp, chrome-devtools-axi, or conversational browser agents for scans.

**Pipeline skill:** [`.cursor/skills/fixflags-audit-pipeline/SKILL.md`](../fixflags-audit-pipeline/SKILL.md) for triage, finalize, and recovery.  
**Journey design (aspirational vs shipped):** [`docs/journey-review-architecture.md`](../../../docs/journey-review-architecture.md)
