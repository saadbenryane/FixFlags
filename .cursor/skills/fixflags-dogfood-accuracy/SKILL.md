...
Read `AGENTS.md`, then `.cursor/skills/fixflags-scan-accuracy/SKILL.md` and `.cursor/skills/fixflags-browser-capture/SKILL.md`. Use Playwright Chromium on the audit path.
