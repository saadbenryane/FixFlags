...
| Canonical improvement loop (Observe → Understand → Judge → Improve → Verify → Learn) | `knowledge/vision.md` → Canonical improvement loop |
...
| Product Review, Update Review, Watch, and future Deep Review | `knowledge/product.md` → Report loop surfaces |
...
| Product surfaces and boundaries | `knowledge/product-system.md` |
