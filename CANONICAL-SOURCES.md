...
| --- | --- | --- |
| Product vision | [knowledge/vision.md](knowledge/vision.md) | Complete owner narrative, accepted 2026-09-08 |
| Implementation order | [ROADMAP.md](ROADMAP.md) | Phases, dependencies, exit evidence, decisions due |
| New behavior requirements | [docs/product-prd.md](docs/product-prd.md) | Target contracts and acceptance scenarios |
| New interface | [docs/workspace-interface.md](docs/workspace-interface.md) | Home, Flags, Site, progressive states |
| Card-board design | [docs/card-board-experience.md](docs/card-board-experience.md) | Flat grid, card anatomy, health/activity separation, library, mobile priority and six-screen prototype |
| Current implementation | [PRODUCT.md](PRODUCT.md) | Code baseline and gaps; never future feature promises |
| Migration and reuse | [docs/site-v2-migration.md](docs/site-v2-migration.md) | Tenant model, adapters, history, billing, cutover |
