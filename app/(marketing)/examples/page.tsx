...
import { ArrowRight, ExternalLink, FileText, MonitorSmartphone, BarChart3 } from 'lucide-react'
        ...
        <Container className="max-w-4xl space-y-8">
          <div className="space-y-3">
            ...
            <Body className="text-muted-foreground max-w-2xl">
              These are automated, context-dependent audits generated by the QualityOS pipeline v
              {PIPELINE_VERSION}. Results are illustrative — every site has unique constraints and
              tradeoffs. These are not endorsements or partnerships.
            </Body>
          </div>
          ...
          <div className="rounded-lg border bg-muted/30 p-5 space-y-3">
            <p className="text-sm font-medium">About these examples</p>
            <ul className="text-xs text-muted-foreground space-y-1.5">
              <li>• All audits are automated and context-dependent — results may vary.</li>
              <li>
                • Scores reflect the pipeline v{PIPELINE_VERSION} scoring model (0-100 objective checks + A-F experience grades).
              </li>
              <li>• These are not official audits or endorsements of the sites shown.</li>
              <li>
                • Run your own URL through the pipeline to see how your site performs.
              </li>
            </ul>
          </div>
