    ...
    <Section spacing="default">
      <Container className="prose prose-neutral dark:prose-invert max-w-3xl space-y-6">
        ...
        <section className="space-y-3 text-sm leading-relaxed text-muted-foreground">
          ...
          <p>
            When you create an account, we store your email and name. When you run an audit, we store
            the URL you submit, screenshots, automated check results, and AI-generated findings.
          </p>

          <h2 className="text-base font-semibold text-foreground">How we use it</h2>
          <p>
            We use this data to generate audit reports, enforce plan limits, and improve the product.
