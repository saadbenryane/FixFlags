import { BRAND_HEX_DARK, gradeColorHex } from '@/lib/design/brand-spec'
...
export function generateBadgeSvg(
  ...
  <defs>
    <linearGradient id="bg" x1="0%" y1="0%" x2="100%" y2="100%">
      <stop offset="0%" style="stop-color:${BRAND_HEX_DARK.background}"/>
      <stop offset="100%" style="stop-color:${BRAND_HEX_DARK.muted}"/>
    </linearGradient>
  </defs>
  ...
  <text x="24" y="80" font-family="system-ui,-apple-system,sans-serif" font-size="24" font-weight="700" fill="${BRAND_HEX_DARK.foreground}">Quality Grade</text>
  <text x="24" y="115" font-family="ui-monospace,monospace" font-size="48" font-weight="800" fill="${fill}">${grade}</text>
  <text x="82" y="115" font-family="system-ui,-apple-system,sans-serif" font-size="16" fill="${BRAND_HEX_DARK.mutedForeground}">${score}/100</text>
  <text x="24" y="152" font-family="system-ui,-apple-system,sans-serif" font-size="12" fill="${BRAND_HEX_DARK.gray400}">${hostname}</text>
</svg>`
}
