...
export const AUDIT_CAPABILITIES: AuditCapability[] = [
  ...
  },
  {
    ...
    tool: 'html-parse',
    status: 'live',
    checkIds: ['form-missing-validation'],
    verify: 'npm run test:unit -- lib/audit/__tests__/checks.test.ts',
    notes: 'Checks form fields for required/aria-required/pattern during HTML parse. Flow-navigation probe (empty submit) is a future extension.',
  },
  {
