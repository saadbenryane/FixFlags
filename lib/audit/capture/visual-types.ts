...
export const VISUAL_DESCRIPTORS: Record<string, VisualDescriptor> = {
  ...
  'form-inputs-zoom-mobile': { type: 'static-overlay', overlay: 'size-labels', device: 'mobile' },
  ...
  'mobile-stuck-loading': { type: 'animated-gif', gifIntervalMs: 1000, gifMaxFrames: 4, device: 'mobile' },
  ...
  'hierarchy-too-many-fonts': { type: 'static-overlay', overlay: 'font-map', device: 'desktop' },
