...
const FAILURE_CODE_MESSAGES: Record<string, string> = {
  ...
  SITE_FORBIDDEN: AUDIT_ERRORS.siteBlocked,
  HTTP_FORBIDDEN: AUDIT_ERRORS.siteBlocked,
  SITE_RATE_LIMITED: AUDIT_ERRORS.rateLimited,
  SITE_UNREACHABLE: AUDIT_ERRORS.unreachable,
  SITE_NOT_HTML: AUDIT_ERRORS.notHtml,
  AI_CONTRACT_INVALID: AUDIT_ERRORS.partialAiReviewContract,
