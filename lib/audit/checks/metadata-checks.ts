...
export function runMetadataChecks(meta: PageMetadata): DeterministicFlag[] {
  ...
  if (!meta.title) {
    ...
    findings.push({
      ...
      evidence: `Title is ${meta.title.length} characters (minimum 10): "${meta.title}"`,
    ...
    findings.push({
      ...
      evidence: `Title is ${meta.title.length} characters (maximum 60): "${meta.title}"`,
  ...
  if (!meta.description) {
    ...
    findings.push({
      ...
      evidence: `Description is ${meta.description.length} characters (minimum 50): "${meta.description}"`,
    ...
    findings.push({
      ...
      evidence: `Description is ${meta.description.length} characters (maximum 160): "${meta.description.slice(0, 80)}..."`,
