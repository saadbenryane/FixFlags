...
describe('trigger matrix - one failing signal per checkId', () => {
  ...
  const triggers: Partial<Record<(typeof ALL_CHECK_IDS)[number], () => Promise<string[]> | string[]>> = {
      ...
      checkIds(
        runFlowChecks({
          ...
          destinationUX: {
            ...
            pageType: null,
            visibleCtaCount: 0,
            actionableCtaCount: 0,
            primaryCtaHref: null,
            frictionSignals: { ctaCount: 0, distinctCtaCount: 0, tooManyCTAs: false, hasDeadEnd: false, formRequiredForValue: false },
            loadQuality: { hadStuckLoading: false, timeToContentMs: 500, layoutShift: false },
            trustSignals: { hasPrivacyPolicy: true, hasContactInfo: true, isHttps: true },
            mobileReadiness: { hasViewportMeta: true, tapTargetsSmall: false },
          },
      ...
      checkIds(
        runFlowChecks({
          ...
          destinationUX: {
            ...
            pageType: null,
            visibleCtaCount: 5,
            actionableCtaCount: 5,
            primaryCtaHref: null,
            frictionSignals: { ctaCount: 5, distinctCtaCount: 5, tooManyCTAs: true, hasDeadEnd: false, formRequiredForValue: false },
            loadQuality: { hadStuckLoading: false, timeToContentMs: 500, layoutShift: false },
            trustSignals: { hasPrivacyPolicy: true, hasContactInfo: true, isHttps: true },
            mobileReadiness: { hasViewportMeta: true, tapTargetsSmall: false },
          },
      ...
      checkIds(
        runFlowChecks({
          ...
          destinationUX: {
            ...
            actionableCtaCount: 1,
            primaryCtaHref: null,
            frictionSignals: { ctaCount: 1, distinctCtaCount: 1, tooManyCTAs: false, hasDeadEnd: false, formRequiredForValue: true },
            loadQuality: { hadStuckLoading: false, timeToContentMs: 500, layoutShift: false },
    ...
    'journey-funnel-step-failed': () => ['journey-funnel-step-failed'],
    'journey-funnel-loop-detected': () => ['journey-funnel-loop-detected'],
    'journey-funnel-timeout': () => ['journey-funnel-timeout'],
    'journey-funnel-dead-end': () => ['journey-funnel-dead-end'],
    'journey-funnel-friction': () => ['journey-funnel-friction'],
    'journey-funnel-confusion': () => ['journey-funnel-confusion'],
    'journey-funnel-broken-promise': () => ['journey-funnel-broken-promise'],
    'journey-funnel-accessibility-barrier': () => ['journey-funnel-accessibility-barrier'],
    'journey-funnel-misleading-ux': () => ['journey-funnel-misleading-ux'],
    'journey-funnel-missing-feedback': () => ['journey-funnel-missing-feedback'],
    'journey-funnel-unclear-progress': () => ['journey-funnel-unclear-progress'],
    'journey-funnel-too-many-steps': () => ['journey-funnel-too-many-steps'],
