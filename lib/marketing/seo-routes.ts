...
export const INDEXABLE_ROUTES: readonly IndexableRoute[] = [
  ...
  { path: '/docs/integrations', seoKey: 'docs', priority: 0.9, changeFrequency: 'monthly' },
  { path: '/docs/cli', seoKey: 'docs', priority: 0.7, changeFrequency: 'monthly' },
  { path: '/docs/mcp/tools', seoKey: 'docs', priority: 0.7, changeFrequency: 'monthly' },
...
export const LLMS_SECTIONS: readonly LlmsSection[] = [
  {
    ...
    links: [
      ...
      { path: '/docs/mcp', label: 'MCP overview', note: 'Transport, authentication, and workflow' },
      { path: '/docs/mcp/tools', label: 'MCP tool reference', note: 'Canonical public tools' },
