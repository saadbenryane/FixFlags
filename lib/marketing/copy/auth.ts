export const AUTH = {
  ...
  signIn: {
    ...
    subtitleWithOAuth: 'Access your reports and continue where you left off',
  ...
  signUp: {
    ...
    subtitleWithOAuth: 'Save your reports, re-check fixes, and track product quality over time',
