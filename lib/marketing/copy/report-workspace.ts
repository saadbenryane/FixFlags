export const REPORT_COPY = {
  workspace: {
    ...
    dashboard: {
      title: "Sites",
      reviewUrlTitle: "Check a website",
      productsHeading: "Your Sites",
      productCount: (count: number) =>
        `${count} ${count === 1 ? "Site" : "Sites"}`,
      sampleBadge: "Legacy sample",
      sampleOpenAria: "Open a legacy sample report (compatibility).",
      sampleAttention: "Or check your own website URL",
      watching: "Watching",
      latestReview: "Latest check",
      attentionLabel: "Attention",
      attentionOpen: (count: number) => `${count} open`,
      noReviewYet: "No Site evidence yet.",
      reviewFailed: "The latest check did not finish.",
      reviewInProgress:
        "Check in progress. New Flags will appear when it finishes.",
      zeroOpen: "0 open Flags in the latest completed check.",
      ...
      openReport: "Open Site",
      openProductAria: (name: string) => `Open Site ${name}.`,
