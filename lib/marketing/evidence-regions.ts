...
const ELEMENT_REGION_PRESETS: Record<string, { width: number; height: number }> = {
  ...
  'loading-indicator-stuck': { width: 0.62, height: 0.22 },
  'loading-state-slow': { width: 0.82, height: 0.22 },
  'flow-cta-stuck-loading': { width: 0.62, height: 0.22 },
  ...
  'slow-3g-blank-screen': { width: 0.92, height: 0.5 },
  'slow-3g-cta-delayed': { width: 0.55, height: 0.07 },
  'form-inputs-zoom-mobile': { width: 0.7, height: 0.15 },
  'scroll-ghost-sections': { width: 0.92, height: 0.35 },
}
...
const VISUAL_TARGET_LABELS: Record<string, string> = {
  ...
  'loading-indicator-stuck': 'Loading spinner or skeleton',
  'loading-state-slow': 'Initial loading state',
  'flow-cta-stuck-loading': 'CTA destination loading state',
  'scroll-ghost-sections': 'Page sections after scroll',
  'slow-3g-blank-screen': 'Page on slow network',
  'slow-3g-cta-delayed': 'CTA on slow network',
  'form-inputs-zoom-mobile': 'Form input fields (mobile)',
