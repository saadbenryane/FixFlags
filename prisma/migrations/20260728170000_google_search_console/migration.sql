...
ALTER TABLE "GscConnection" ADD CONSTRAINT "GscConnection_userId_fkey"
  FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "SearchPerformance" ADD CONSTRAINT "SearchPerformance_auditId_fkey"
  FOREIGN KEY ("auditId") REFERENCES "audits"("id") ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "SearchPerformance" ADD CONSTRAINT "SearchPerformance_userId_fkey"
  FOREIGN KEY ("userId") REFERENCES "GscConnection"("userId") ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "IndexStatus" ADD CONSTRAINT "IndexStatus_auditId_fkey"
  FOREIGN KEY ("auditId") REFERENCES "audits"("id") ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "IndexStatus" ADD CONSTRAINT "IndexStatus_userId_fkey"
  FOREIGN KEY ("userId") REFERENCES "GscConnection"("userId") ON DELETE SET NULL ON UPDATE CASCADE;
