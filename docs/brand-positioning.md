...
Lead with continued care for the website. Demonstrate a real Site answer, an important Journey and a Flag with evidence and verified recovery. Explain monitoring through visible coverage and quiet healthy states. Offer more context only when it makes an existing answer more useful.
...
The phased communication rollout, including pricing, help, metadata and Shopify, belongs in [product-masterplan.md](product-masterplan.md). [ROADMAP.md](../ROADMAP.md) remains the Site engineering cutover.
